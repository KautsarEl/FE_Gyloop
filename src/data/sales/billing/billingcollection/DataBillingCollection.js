// Table ID : billing.collection.header
// Short Description : Billing Collection Header
// Type : Transparent Table
// Notes: N/A
const billing_collection_header = [
    {

    }
]

// Table ID : billing.collection.item 
// Short Description : Billing Collection Item
// Type : Transparent Table
// Notes: N/A
const billing_collection_item = [
    {
...
export {
    billing_collection_header,
    billing_collection_item,
    logs_data_header,
    logs_data_item,
}