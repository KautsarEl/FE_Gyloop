// Table ID : service.settlement.header
// Short Description : Service Settlement Header
// Type : Transparent Table
// Notes: N/A
const service_settlement_header = [
    {

    }
]

// Table ID : service.settlement.item 
// Short Description : Service Settlement Item
// Type : Transparent Table
// Notes: N/A
const service_settlement_item = [
    {
...
export {
    service_settlement_header,
    service_settlement_item,
    logs_data_header,
    logs_data_item,
}