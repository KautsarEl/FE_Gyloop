// Table ID : service.dispatching.header
// Short Description : Service Dispatching Header
// Type : Transparent Table
// Notes: N/A
const service_dispatching_header = [
    {

    }
]

// Table ID : service.dispatching.item 
// Short Description : Service Dispatching Item
// Type : Transparent Table
// Notes: N/A
const service_dispatching_item = [
    {
...
export {
    service_dispatching_header,
    service_dispatching_item,
    logs_data_header,
    logs_data_item,
}