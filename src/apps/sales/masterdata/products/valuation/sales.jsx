          ...
          <Row className=" Row-SystemId">
            <Col>
              <div className=" flex flex-col gap-[24px]">
                ...
                <div className=" flex gap-[15px] items-end w-full">
                  <InputText
                    label="Sales Price Per Quantity"
                    id="sale_qnty_pric"
                    disabled={disabled}
                    placeholder="1,00"
                    required={true}
                ...
                <Switch
                  id={"is_sale_mins"}
                  label="Is Use Minimum Sales Quantity?"
                  disabled={disabled}
                />
                <div className=" flex gap-[15px] items-end w-full">
                  <InputText
                ...
                <Switch
                  id={"is_sale_lots"}
                  label="Is Use Lot Sales Quantity"
                  disabled={disabled}
                />
                <div className=" flex gap-[15px] items-end w-full">
                  <InputText
                    label="Lot Sales Quantity"
                    id="qnty_sale_lots"
                    disabled={disabled}
                    placeholder="1,00"
                    required={true}
                ...
                <Switch
                  id={"is_sale_surc"}
                  label="Is Use Default Sales Surcharge Item?"
                  disabled={disabled}
                />
                <SelectBasic
                  label={"Sales Surcharge Item"}
                  id="assg_sale_surc"
                  options={[]}
                  disabled={disabled}
                  placeholder="Please select sales surcharge item"
                  rules={{ required: "This field is required" }}
                />
              </div>
            </Col>
