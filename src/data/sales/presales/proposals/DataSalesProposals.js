// Table ID : sales.proposals.header
// Short Description : Sales Proposals Header
// Type : Transparent Table
// Notes: N/A
const sales_proposals_header = [
    {

    }
]

// Table ID : sales.proposals.item 
// Short Description : Sales Proposals Item
// Type : Transparent Table
// Notes: N/A
const sales_proposals_item = [
    {
...
export {
    sales_proposals_header,
    sales_proposals_item,
    logs_data_header,
    logs_data_item,
}