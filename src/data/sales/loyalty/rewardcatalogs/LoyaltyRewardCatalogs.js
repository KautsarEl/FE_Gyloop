// Table ID : loyalty.catalogs.header
// Short Description : Loyalty Reward Catalogs Header
// Type : Transparent Table
// Notes: N/A
const loyalty_catalogs_header = [
    {

    }
]

// Table ID : loyalty.catalogs.item
// Short Description : Loyalty Reward Catalogs Item
// Type : Transparent Table
// Notes: N/A
const loyalty_catalogs_item = [
    {
...
export {
    loyalty_catalogs_header,
    loyalty_catalogs_item,
    logs_data_header,
    logs_data_item,
}