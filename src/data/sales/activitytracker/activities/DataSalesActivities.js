// Table ID : sales.activities.header
// Short Description : Sales Activities Header
// Type : Transparent Table
const salesactivities_header = [
    {

    }
]

// Table ID : sales.activities.item
// Short Description : Sales Activities Item
// Type : Transparent Table
const salesactivities_item = [
    {
...
export {
    salesactivities_header,
    salesactivities_item,
    logs_data_header,
    logs_data_item,
}