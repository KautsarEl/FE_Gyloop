...
export default function Organizationid() {
  ...
  const [filteredData, setFilteredData] = useState(organizationid_config);

  const handleSearch = (e) => {
    const value = e.target.value.toLowerCase();
    setSearch(value);

    const filtered = organizationid_config.filter((item) =>
          ...
          <div className="custom-table" style={{ position: "relative" }}>
            ...
            >
              ...
              <div className=" container-action-table">
                <Link to={'/apps/administration/orgsystems/organizationiddetail'}>
                  <Button
                    variant="primary"
