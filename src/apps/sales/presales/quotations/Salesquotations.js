...
import { column_table_quotations, data_table_quotations } from "../../../../data/sales/presales/quotations/DataSalesCode";
import { sales_proposals_header_table } from "../../../../data/sales/presales/quotations/DataSalesQuotationsTable";
...
export default function Salesquotations() {
  ...
  const columns = column_table_quotations.map((column) => column.title); // Use 'name' for column headers
  ...
  const [filteredData, setFilteredData] = useState(data_table_quotations);

  const handleSearch = (e) => {
    const value = e.target.value.toLowerCase();
    setSearch(value);

    const filtered = data_table_quotations.filter((item) =>
  ...
  sales_proposals_header_table.map((item)=> menu.push({menu:item.name_fild}))
      ...
      <div className="main main-table p-3 p-lg-4">
        <div className="d-md-flex align-items-center justify-content-between mb-4">
          <div>
            ...
            <h4 className="main-title mb-0">Quotations Report</h4>
          </div>
          <Guidiance />
        </div>
          ...
          <div className="custom-table" style={{ position: "relative" }}>
            ...
            >
              ...
              <div className=" container-action-table">
                <Link
                  to={"/apps/sales/presales/quotations/salesquotationscreate"}
                >
                  <Button
                    variant="primary"
