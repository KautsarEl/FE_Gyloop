// Table ID : sales.contracts.header
// Short Description : Sales Contracts Header
// Type : Transparent Table
// Notes: N/A
const sales_contracts_header = [
    {

    }
]

// Table ID : sales.contracts.item 
// Short Description : Sales Contracts Item
// Type : Transparent Table
// Notes: N/A
const sales_contracts_item = [
    {
...
export {
    sales_contracts_header,
    sales_contracts_item,
    logs_data_header,
    logs_data_item,
}