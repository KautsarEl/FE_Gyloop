// Table ID : crm.report.inventory.header
// Short Description : CRM Inventory Report Header
// Type : Transparent Table
// Notes: N/A
const inventory_report_header = [
    {

    }
]

// Table ID : crm.report.inventory.item
// Short Description : CRM Inventory Report Item
// Type : Transparent Table
// Notes: N/A
const inventory_report_item = [
    {
...
export {
    inventory_report_header,
    inventory_report_item,
    logs_data_header,
    logs_data_item,
}