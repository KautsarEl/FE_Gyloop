// Table ID : delivery.tracking.header
// Short Description : Delivery Tracking Header
// Type : Transparent Table
// Notes: N/A
const delivery_tracking_header = [
    {

    }
]

// Table ID : delivery.tracking.item
// Short Description : Delivery Tracking Item
// Type : Transparent Table
// Notes: N/A
const delivery_tracking_item = [
    {
