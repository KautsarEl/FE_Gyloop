// Table ID : sales.offices.header
// Short Description : Sales Offices Header
// Type : Transparent Table
// Notes: Will use across Apps
const sales_offices_header = [
    {

    }
]

// Table ID : sales.offices.item 
// Short Description : Sales Offices Item
// Type : Transparent Table
// Notes: N/A
const sales_offices_item = [
    {
