// Table ID : customer.master.header
// Short Description : Customer Master Header
// Type : Transparent Table
// Notes: General Contacts will use to across apps (e.g.: CRM, SRM, elt.)
const customer_master_header = [
    {

    }
]

// Table ID : customer.master.item 
// Short Description : Customer Master Item
// Type : Transparent Table
// Notes: General Contacts will use to across apps (e.g.: CRM, SRM, elt.)
const customer_master_item = [
    {
...
export {
    customer_master_header,
    customer_master_item,
    logs_data_header,
    logs_data_item,
}