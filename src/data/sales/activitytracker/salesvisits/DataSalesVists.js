// Table ID : sales.visits.header
// Short Description : Sales Visits Header
// Type : Transparent Table
const sales_visits_header = [
    {

    }
]

// Table ID : sales.visits.item
// Short Description : Sales Visits Item
// Type : Transparent Table
const sales_visits_item = [
    {
