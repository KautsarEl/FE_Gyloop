// Table ID : delivery.orders.header
// Short Description : Delivery Orders Header
// Type : Transparent Table
// Notes: N/A
const delivery_orders_header = [
    {

    }
]

// Table ID : delivery.orders.item
// Short Description : Delivery Orders Item
// Type : Transparent Table
// Notes: N/A
const delivery_orders_item = [
    {
...
export {
    delivery_orders_header,
    delivery_orders_item,
    logs_data_header,
    logs_data_item,
}