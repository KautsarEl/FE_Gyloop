// Table ID : sales.recurring.orders.header
// Short Description : Sales Recurring Order Header
// Type : Transparent Table
// Notes: N/A
const sales_recurring_order_header = [
    {

    }
]

// Table ID : sales.recurring.orders.item 
// Short Description : Sales Recurring Order Item
// Type : Transparent Table
// Notes: N/A
const sales_recurring_order_item = [
    {
...
export {
    sales_recurring_order_header,
    sales_recurring_order_item,
    logs_data_header,
    logs_data_item,
}