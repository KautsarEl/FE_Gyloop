// Table ID : apps.utilities.header
// Short Description : Apps Utilities Header
// Type : Transparent Table
// Notes: N/a
const apps_utilities_header = [
    {

    }
]

// Table ID : apps.utilities.item 
// Short Description : Apps Utilities Item
// Type : Transparent Table
// Notes: N/A
const apps_utilities_item = [
    {
