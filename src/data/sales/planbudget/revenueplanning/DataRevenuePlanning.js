// Table ID : sales.revenue.planning.header
// Short Description : Sales Revenue Planning Header
// Type : Transparent Table
// Notes: N/A
const sales_revenue_planning_header = [
    {

    }
]

// Table ID : sales.revenue.planning.item 
// Short Description : Sales Revenue Planning Item
// Type : Transparent Table
// Notes: N/A
const sales_revenue_planning_item = [
    {
...
export {
    sales_revenue_planning_header,
    sales_revenue_planning_item,
    logs_data_header,
    logs_data_item,
}