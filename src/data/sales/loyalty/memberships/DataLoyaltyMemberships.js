// Table ID : loyalty.memberships.header
// Short Description : Loyalty Memberships Header
// Type : Transparent Table
// Notes: N/A
const loyalty_memberships_header = [
    {

    }
]

// Table ID : loyalty.memberships.item
// Short Description : Loyalty Memberships Item
// Type : Transparent Table
// Notes: N/A
const loyalty_memberships_item = [
    {
...
export {
    loyalty_memberships_header,
    loyalty_memberships_item,
    logs_data_header,
    logs_data_item,
}