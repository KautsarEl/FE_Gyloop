// Table ID : territory.scopes.header
// Short Description : Territories Header
// Type : Transparent Table
// Notes: Will use across Apps
const territory_scopes_header = [
    {

    }
]

// Table ID : territory.scopes.item 
// Short Description : Territories Item
// Type : Transparent Table
// Notes: N/A
const territory_scopes_item = [
    {
...
export {
    territory_scopes_header,
    territory_scopes_item,
    logs_data_header,
    logs_data_item,
}