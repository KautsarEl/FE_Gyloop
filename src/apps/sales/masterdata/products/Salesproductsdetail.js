...
export default function Salesproductsdetail() {
  const { id } = useParams();
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`http://203.175.11.244:8080/api/products/${id}`)
        .then((res) => {
        ...
        <div className="main main-table p-3 p-lg-4 mb-[60px]">
          <div className="d-md-flex align-items-center justify-content-between mb-4">
            <div>
              ...
              <h4 className="main-title mb-0">Display Product</h4>
            </div>
            <div className="d-flex gap-2 mt-3 mt-md-0">
              <Link
                to={`/apps/sales/masterdata/products/salesproductschange/${id}`}
              >
                <Button
                  variant=""
