...
export default function TermsofPayment({ disabled }) {
            ...
            <Table responsive className="mb-0">
              <thead>
                <tr>
                  ...
                  <th scope="col">
                    <p className="m-0 min-w-max">Payment Group</p>
                  </th>
                  <th scope="col">
                    <p className="m-0 min-w-max">Milestones</p>
                  </th>
                  <th scope="col">
                    <p className="m-0 min-w-max">Percentage</p>
                  </th>
                  <th scope="col">
