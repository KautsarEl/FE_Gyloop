// Table ID : voucher.masters.header
// Short Description : Voucher Masters Header
// Type : Transparent Table
// Notes: N/A
const voucher_masters_header = [
    {

    }
]

// Table ID : voucher.masters.item 
// Short Description : Voucher Masters Item
// Type : Transparent Table
// Notes: N/A
const voucher_masters_item = [
    {
...
export {
    voucher_masters_header,
    voucher_masters_item,
    logs_data_header,
    logs_data_item,
}