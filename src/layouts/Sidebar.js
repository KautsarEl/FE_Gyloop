...
import { currentSorc_Depl } from "../data/administration/orgsystems/systemid/DataSystemid";
                ...
                <div className="sidebar-footer">
                    <div className="sidebar-footer-top">
                        ...
                        <div className="sidebar-footer-body">
                            <h6><Link>Gyloop Business R1.0</Link></h6>
                            <p>{currentSorc_Depl}</p>
                        </div>
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <div className="nav-group show"></div> */}
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Network</div>
                    {this.populateMenu(networkMenu)}
                </div>
                {/* <div className="nav-group show"></div> */}
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Portal</div>
                    {this.populateMenu(portalMenu)}
                </div>
                {/* <div className="nav-group show"></div> */}
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Sales</div>
                    {this.populateMenu(crmAppsMenu)}
                </div>
                {/* <div className="nav-group show"></div> */}
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Purchase</div>
                    {this.populateMenu(srmAppsMenu)}
                </div>
                {/* <div className="nav-group show"></div> */}
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Warehouse</div>
                ...
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Administrations</div>
                    {this.populateMenu(adminMenu)}
                </div>
                <div className="nav-group">
                    <div className="nav-label" onClick={this.toggleMenu}>Configurations</div>
