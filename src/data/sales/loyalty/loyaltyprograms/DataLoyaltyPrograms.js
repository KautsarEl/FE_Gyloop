// Table ID : loyalty.programs.header
// Short Description : Loyalty Programs Header
// Type : Transparent Table
// Notes: N/A
const loyalty_programs_header = [
    {

    }
]

// Table ID : loyalty.programs.item
// Short Description : Loyalty Programs Item
// Type : Transparent Table
// Notes: N/A
const loyalty_programs_item = [
    {
...
export {
    loyalty_programs_header,
    loyalty_programs_item,
    logs_data_header,
    logs_data_item,
}