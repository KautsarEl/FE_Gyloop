    ...
    <div className="px-[20px] py-[30px]">
      ...
      <div className=" mb-[25px]">
        <div className=" flex justify-between items-center mb-[10px]">
          <Form.Label className="f-1 form-label-custom">Voucher</Form.Label>
          <Button
            variant=""
          ...
          <Table responsive className="mb-0">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <p className="m-0 min-w-max">Voucher Code </p>
                </th>
                <th scope="col">
                  <p className="m-0 min-w-max">Validity</p>
                </th>
                <th scope="col">
                  <p className="m-0 min-w-max">Type</p>
                </th>
                <th scope="col">
                  <p className="m-0 min-w-max">Category</p>
                </th>
                <th scope="col">
                  <p className="m-0 min-w-max">Total Amount</p>
                </th>
              </tr>
            </thead>
            <tbody>
