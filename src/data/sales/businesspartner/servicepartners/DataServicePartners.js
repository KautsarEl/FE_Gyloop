// Table ID : service.partners.header
// Short Description : Service Partners Header
// Type : Transparent Table
// Notes: N/A
const service_partners_header = [
    {

    }
]

// Table ID : service.partners.item 
// Short Description : Service Partners Item
// Type : Transparent Table
// Notes: N/A
const service_partners_item = [
    {
...
export {
    service_partners_header,
    service_partners_item,
    logs_data_header,
    logs_data_item,
}