// Table ID : standard.terms.header
// Short Description : Standard Terms Header
// Type : Transparent Table
// Notes: Will use across Apps
const standard_terms_header = [
    {

    }
]

// Table ID : standard.terms.item 
// Short Description : Standard Terms Item
// Type : Transparent Table
// Notes: N/A
const standard_terms_item = [
    {
