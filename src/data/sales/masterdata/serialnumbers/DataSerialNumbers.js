// Table ID : serial.numbers.header
// Short Description : Serial Number Header
// Type : Transparent Table
// Notes: Will use across Apps
const serial_number_header = [
    {

    }
]

// Table ID : serial.numbers.item 
// Short Description : Serial Number Item
// Type : Transparent Table
// Notes: N/A
