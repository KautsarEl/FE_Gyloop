// Table ID : service.confirmations.header
// Short Description : Service Confirmations Header
// Type : Transparent Table
// Notes: N/A
const service_confirmations_header = [
    {

    }
]

// Table ID : service.confirmations.item 
// Short Description : Service Confirmations Item
// Type : Transparent Table
// Notes: N/A
const service_confirmations_item = [
    {
...
export {
    service_confirmations_header,
    service_confirmations_item,
    logs_data_header,
    logs_data_item,
}