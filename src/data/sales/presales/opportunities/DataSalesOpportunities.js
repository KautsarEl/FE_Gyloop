// Table ID : sales.opportunities.header
// Short Description : Sales Opportunities Header
// Type : Transparent Table
// Notes: N/A
const sales_opportunities_header = [
    {

    }
]

// Table ID : sales.opportunities.item 
// Short Description : Sales Opportunities Item
// Type : Transparent Table
// Notes: N/A
const sales_opportunities_item = [
    {
...
export {
    sales_opportunities_header,
    sales_opportunities_item,
    logs_data_header,
    logs_data_item,
}