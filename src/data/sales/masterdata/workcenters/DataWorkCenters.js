// Table ID : work.centers.header
// Short Description : Work Centers Header
// Type : Transparent Table
// Notes: Will use across Apps
const work_centers_header = [
    {

    }
]

// Table ID : work.centers.item 
// Short Description : Work Centers Item
// Type : Transparent Table
// Notes: N/A
const work_centers_item = [
    {
